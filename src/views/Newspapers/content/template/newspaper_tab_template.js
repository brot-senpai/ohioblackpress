...
//Step 2) This is the secon step. It initializes the Pop-up content of the newspaper. 
//This step is very complicated because it calls all the component for the newspaper. 
//After this file is complete, go to "views/Newspaper/content" find the file 
//newspapers_data.json and add the location of this file to it. Follow the same
//convention. 
//When complete, go to content folder from within this compent to content_info_template.js
//file for step 3.
